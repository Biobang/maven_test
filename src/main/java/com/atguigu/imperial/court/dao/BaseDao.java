...
public abstract class BaseDao<T> {
    ...
    public T getSingleBean(String sql, Class<T> entityClass, Object ... parameters) {
        ...
        try {
            ...
            return queryRunner.query(connection, sql, new BeanHandler<>(entityClass), parameters);
    ...
    public int update(String sql, Object ... parameters) {
        ...
        try {
            ...
            int affectedRowNumbers = queryRunner.update(connection, sql, parameters);
    ...
    public List<T> getBeanList(String sql, Class<T> entityClass, Object ... parameters) {
        try {
            ...
            return queryRunner.query(connection, sql, new BeanListHandler<>(entityClass), parameters);
